<?php
      ...
      if($connectorDB->insertData('eventos', $data)){ //Insertar la información en la base de datos
          /*Mostrar mensaje success*/
          $resultado = $connectorDB->consult(['eventos'],['MAX(id)']); //Obtener el id registrado perteneciente al nuevo registro
